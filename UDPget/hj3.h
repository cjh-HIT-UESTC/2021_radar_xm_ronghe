...
typedef struct {
	...
	unsigned int time_of_updata;	//更新时间 UTC时间
	...
	unsigned int tgt_rng;			//目标距离 m
	unsigned int rdr_vel;					//径向速度 m/s
	unsigned int tgt_az;					//目标方位 正北系，顺时针，0~360°
	unsigned int cruise_velocity;			//载机航速 m/s
	unsigned int cruise_heading;			//载机航向 正北系，顺时针，0~360°
